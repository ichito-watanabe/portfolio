...
export const projects: Project[] = [
  {
    ...
    mainImagePath: "/images/auspice_vol1_1.jpg",
    contentBlocks: [
      {
        type: "text",
  ...
  },
  {
    ...
    mainImagePath: "/images/auspice_vol2_1.jpg",
    contentBlocks: [
      {
        type: "text",
      ...
      {
        type: "text",
        text: "まず、組織として機能するイベントにするため、私はあえて前面に立たず、友人を主催として立て、自分はサポート役に回る体制へ変更しました。第1回では役割分担を行っていなかったため、継続性に不安がありました。そこで役割を明確化し、私は受付対応、広報設計、出店（NUTSMASON）、全体調整を担う形に再構築しました。",
      },
      {
        type: "text",
  ...
  },
  {
    ...
    mainImagePath: "/images/auspice_vol3_1.jpg",
    contentBlocks: [
      {
        type: "text",
  ...
  {
    title: "ローカルイベント AUSPICE vol.4 開催",
    slug: "local-event-auspice-vol4",
    dateLabel: "2026-03-29",
    description: "地域の飲食店と連携した施策で集客と購買を伸ばし、AUSPICE vol.4で過去最大の来場者数と売上を達成しました。",
    techStack: ["Community", "Marketing", "Partnership", "Operation"],
    mainImagePath: "/images/auspice_vol4_1.jpg",
    contentBlocks: [
      {
        type: "text",
        text: "第4回となる今回は、第3回までの流れを踏まえ、大きな構成変更は行わず、これまで積み重ねてきた改善をさらに磨き込むことで、イベント全体の価値を高めることに挑戦しました。メイン写真は、当日出演してくれたみんなで撮った一枚です。本当にありがとうございました！",
      },
      {
        type: "text",
        text: "その結果、来場者数は過去最大となる55名を記録しました。回を重ねるごとに少しずつ認知が広がり、「また来たい」と思ってくれる人が増えてきたことを、これまで以上にはっきり実感できた回でした。",
      },
      {
        type: "text",
        text: "今回新たに取り組んだのは、地域の飲食店と連携した集客施策です。自分が実際に足を運び、「ここはかっこいい」と感じた飲食店の店主の方々に直接お話しし、イベントのビラを店内に置いていただきました。",
      },
      {
        type: "text",
        text: "さらに、そのビラをイベント当日に持参してもらうと、出店で使える400円分の割引チケットを渡す仕組みを導入しました。ビラの裏には各飲食店の名前を書いておき、異なる店舗のビラを持ってくるごとに追加で割引チケットがもらえるようにしたことで、来場者が複数のお店を回るきっかけもつくることができました。",
      },
      {
        type: "text",
        text: "この施策によって、地域の飲食店への還元とイベント内での購買促進を同時に実現することができました。実際に出店者の売上も伸び、売上の10%を収益としている本イベントでは、全体売上が過去最大となる10万円以上を記録し、黒字化も達成しました。",
      },
      {
        type: "text",
        text: "運営面では、私は引き続き全体の調整や進行管理を担当しました。回数を重ねる中で、チーム内の役割分担や連携もかなりスムーズになってきて、以前よりも落ち着いて全体を見ながら動けるようになったと感じています。",
      },
      {
        type: "text",
        text: "今回の経験を通して、イベントは一発の工夫で大きく変わるものではなく、小さな改善の積み重ねが大きな成果につながること、そして地域を巻き込みながら価値を広げていくことの面白さを改めて実感しました!",
      },
      {
        type: "image",
        src: "/images/auspice_vol4_2.jpg",
        alt: "AUSPICE vol.4 sub image",
      },
      {
        type: "text",
        text: "この日も本当にいい空間になりました。音楽も会話も買い物も自然につながっていて、すごく幸せな時間でした！",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    contentBlocks: [
      {
        type: "text",
        text: "花粉症を理由にした行動や体調不良の「言い訳」を生成するアプリ「花粉言い訳エクスキューズジェネレーター」を、5人チームで約2週間かけて開発し、最終的にサポーターズ賞をいただきました！",
      },
      {
        type: "text",
      ...
      {
        type: "text",
        text: "加えて、APIキーの発行や認証設定、課金設定などの環境構築の部分を担当しました。ハッカソンって短期決戦なので、コードを書く前にまず外部サービスをちゃんと使える状態にしておくのが大事だと思って、開発初期に基盤周りを先回りして整えたことによって、スムーズにチーム開発を進めることができました。",
      },
      {
        type: "text",
        text: "設計面では、複数のAPIを組み合わせて使うためのスキーマ設計も提案し、実際のシステム設計に採用されました。位置情報、花粉指数、ユーザー入力、LLMの出力をどうつなぐかを整理しておいたことで、フロントエンド側とも連携しやすくなって、チーム開発がかなり進めやすかったです。",
      },
      {
        type: "text",
      ...
      {
        type: "text",
        text: "それと今回本当に大きかったのは、チームメンバーの存在です.フロントエンド担当のメンバーがUIやUXをすごく分かりやすくまとめてくれたおかげで、バックエンドで集めた情報もちゃんとユーザーに伝わる形にできました。短い期間だったのに、みんなそれぞれ強みを出して開発を進められて本当にありがたかったです！チーム開発って、自分の担当をやり切るだけじゃなくて、他の人が動きやすい形をつくることも大事なんだなと学びました。",
      },
    ],
  },
];

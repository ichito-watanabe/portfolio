...
export const projects: Project[] = [
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      {
        type: "text",
        text: "それと今回本当に大きかったのは、チームメンバーの存在です！フロントエンド担当のメンバーがUIや体験設計をすごく分かりやすくまとめてくれたおかげで、バックエンドで集めた情報もちゃんとユーザーに伝わる形にできました。短い期間だったのに、みんなそれぞれ強みを出して開発を進められて本当にありがたかったです！チーム開発って、自分の担当をやり切るだけじゃなくて、他の人が動きやすい形をつくることも大事なんだなと学びました。",
      },
    ],
  },
];

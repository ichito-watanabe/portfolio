...
export const projects: Project[] = [
  ...
  },
  {
    ...
    contentBlocks: [
      {
        type: "text",
        text: "花粉症を理由にした行動や体調不良の「言い訳」を生成するアプリ「花粉言い訳エクスキューズジェネレーター」を、5人チームで約2週間かけて開発しました！技育CAMPのハッカソンで制作し、最終的にサポーターズ賞をいただけたのが本当にうれしかったです！",
      },
      {
        type: "text",
      ...
      {
        type: "text",
        text: "加えて、APIキーの発行や認証設定、課金設定などの環境構築も担当しました。ハッカソンって短期決戦なので、コードを書く前にまず外部サービスをちゃんと使える状態にしておくのが大事だと思って、開発初期に基盤周りを先回りして整えました！",
      },
      {
        type: "text",
        text: "設計面では、複数のAPIを組み合わせて使うためのスキーマ設計も提案し、実際のシステム設計に採用されました。位置情報、花粉指数、ユーザー入力、LLMの出力をどうつなぐかを整理しておいたことで、フロントエンド側とも連携しやすくなって、チーム開発がかなり進めやすくなりました！",
      },
      {
        type: "text",
      ...
      {
        type: "text",
        text: "それと今回ほんとうに大きかったのは、チームメンバーの存在です！フロントエンド担当のメンバーがUIや体験設計をすごく分かりやすくまとめてくれたおかげで、バックエンドで集めた情報もちゃんとユーザーに伝わる形にできました。短い期間だったのに、みんなそれぞれ強みを出して開発を進められて本当にありがたかったです！チーム開発って、自分の担当をやり切るだけじゃなくて、他の人が動きやすい形をつくることも大事なんだなと学びました！",
      },
    ],
  },
];

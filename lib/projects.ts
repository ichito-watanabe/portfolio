...
export const projects: Project[] = [
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      {
        type: "text",
        text: "特に印象に残っているのは、「なぜその手法を選んだのか？」や「他の方法ではだめなのか？」といった質問をいただいたことです。研究室の中では当たり前だと思っていた前提が、外に出ると必ずしも共有されていないことに気づきました。",
      },
      {
        type: "text",
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      {
        type: "text",
        text: "今回はさらにパワーアップして、実際にクラブで回しているDJをお呼びし、ショーケースの時間も用意。出演する子どもたちには、選曲・編曲・振り付けまで自分たちで考えてもらい、与えられたダンスではなく、自分たちでつくるダンスを発表してもらいました。イベントとしての完成度は確実に上がったと思います。",
      },
      {
        type: "text",
      ...
      {
        type: "text",
        text: "進化はできたのですが届けきれなかった。その悔しさを、次の一歩のエネルギーにします！",
      },
      {
        type: "youtube",
